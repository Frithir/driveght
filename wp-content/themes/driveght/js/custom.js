  ...
  $('#tours h3').click(function() {
    ...
    if (
      ...
      $('#packages .content').html(
        '<h4>For this set up your looking at about <span id="ballpark">$0 cause you need to select a Track and a Car so we can show you what its worth</span></h4>'
      )
      ...
      $('#ballpark').html(
        ' $' +
          (parseInt(car.find('.price').text()) +
            parseInt(track.find('.price').text()))
      )
